...
document.write(`
    ...
    <div id="resultAreaTask1"></div>
    `);

function handleButtonClick(buttonId, message) {
  const btn = document.getElementById(buttonId);
  const resultArea = document.getElementById("resultAreaTask1")
...
document.write(`
  <h2>Task 2: </h2>
  <div id="resultAreaTask2">Mouse X: 0, Mouse Y: 0</div>
  `);
...
function trackMousePosition() {
  document.addEventListener("mousemove", function (event) {
    ...
    console.log(`Mouse X: ${posX}, Mouse Y: ${posY}`);
    let resultArea = document.getElementById("resultAreaTask2");
    resultArea.textContent = `Mouse X: ${posX}, Mouse Y: ${posY}`;
  })
}
